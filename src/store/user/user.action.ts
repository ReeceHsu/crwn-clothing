...
export type SignUpSuccess = ActionWithPayload<
	...
	{ user: User; addtionalDetails: AdditionalInformation }
>;

export const signUpSuccess = withMatcher(
	(user: User, addtionalDetails: AdditionalInformation): SignUpSuccess =>
		createAction(USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user, addtionalDetails }),
);

export type SignUpFaild = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_FAILED, Error>;

export const signUpFailed = withMatcher(
	(error: Error): SignUpFaild => createAction(USER_ACTION_TYPES.SIGN_UP_FAILED, error),
);
...
export type SignOutFailed = ActionWithPayload<USER_ACTION_TYPES.SGIN_OUT_FAILED, Error>;

export const signOutFailed = withMatcher(
	(error: Error): SignOutFailed => createAction(USER_ACTION_TYPES.SGIN_OUT_FAILED, error),
);
